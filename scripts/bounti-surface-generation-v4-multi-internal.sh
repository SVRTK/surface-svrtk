...
if [ "$#" -ne 5 ]; then
    echo ""
    echo "Draw-EM based fetal brain surface generation from BOUNTI-V2.0 47 mulri-ROI labels"
    echo
    ...
    echo "[full path to BOUNTI.V02 labels file - e.g., /home/data/in-files/sub-1234_ses-000-mask-brain_bounti-47.nii.gz]"
...
bounti_labels_roi=mask-brain_bounti-47
bet_labels_roi=mask-brain_bet-1
bounti_labels_roi_final=mask-brain_bounti-47-internal
